...
public class LowStockListEventSubscriber implements MessageProcessor {
    ...
    private ObjectToJson lowStockListToJSON;
    
    public void setLowStockListToJSON(final ObjectToJson lowStockListToJSON) {
        this.lowStockListToJSON = lowStockListToJSON;
    }
    ...
    public MuleEvent process(final MuleEvent muleEvent) throws MuleException {
        ...
        try { 
        	LowStockList lowStockListMsgIni =  LowStockData.getLowStockData();
			Object jsonMsgIni = lowStockListToJSON.transform(lowStockListMsgIni);
        ...
        String statement = "SELECT * FROM LowStockListEvent";

        esperModule.listen(statement, new SourceCallback() {
        	
            public Object process(Object payload) {
            	try {            		
            		LowStockList lowStockListMsg = (LowStockList) payload;
            		Object jsonMsg = lowStockListToJSON.transform(lowStockListMsg);
